...
#C file write time: 2023-06-11 19:44:24
petrale_data.ss
petrale_control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1874
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1687839336
